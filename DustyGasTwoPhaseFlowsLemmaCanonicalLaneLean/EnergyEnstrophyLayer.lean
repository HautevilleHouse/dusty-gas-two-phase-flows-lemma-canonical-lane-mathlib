import DustyGasTwoPhaseFlowsLemmaCanonicalLaneLean.LerayHopfWeakLayer

/-!
# Energy And Enstrophy Layer

This module binds the source constants into proof-carrying energy and enstrophy obligations.
-/
